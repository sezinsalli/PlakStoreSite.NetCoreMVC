    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "ID", "ActivationCode", "Address", "CreatedDate", "Email", "FirstName", "LastName", "ModifiedDate", "Password", "PhoneNumber", "Role", "ısActive" },
                values: new object[] { 1, new Guid("00000000-0000-0000-0000-000000000000"), "sezsez", new DateTime(2022, 3, 30, 23, 29, 54, 821, DateTimeKind.Local).AddTicks(8994), "sezin@gmail.com", "Sezin", "Şallı", null, "123", null, 2, true });
